...
from exp.exp_evalution import Exp_Main
import random
import numpy as np
import time
...
## ETSformer:  make sure your en_de blocks equal !!
'TimesNet ----big model!!!'

# Model_option=['MICN']
Model_option=['TimesNet','Autoformer','Nonstationary_Transformer','PatchTST',
          'Informer','LightTS','ETSformer','Pyraformer','Crossformer','FiLM','FEDformer','Reformer','MICN']

# Model_option=['Nonstationary_Transformer','PatchTST','LightTS','Autoformer','FEDformer','Crossformer']

Model_option=['MICN']

Lr_option=[1e-3,8e-4,6.5e-4,5e-4,1e-4,5e-5]
...
input_label_pres_opt=[[144,144,32]]
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='FEDformer')
    ...
    parser.add_argument('--train_epochs', type=int, default=248, help='train epochs')
