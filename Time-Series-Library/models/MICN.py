...
class Model(nn.Module):
    ...
    def __init__(self, configs, conv_kernel=[12, 16]):
        ...
        self.pro_head_1=nn.Linear(configs.pred_len+configs.label_len,configs.pred_len)
        self.pro_head_2=nn.Linear(configs.pred_len+configs.label_len,configs.pred_len)
    ...
    def forecast(self, x_enc, x_mark_enc, x_dec, x_mark_dec):
        ...
        # trend_init=self.pro_head_1(trend_init.permute(0,2,1)).permute(0,2,1)
        seasonal_init_dec=self.pro_head_2(seasonal_init_dec.permute(0,2,1)).permute(0,2,1)
