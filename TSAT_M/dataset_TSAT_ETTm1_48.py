...
def generate_hd_data(n_lookback_days:int, n_lookforward_days:int, adj_mat_method:str, use_tqdm:bool):
    import time
    start_time = time.time()
    df = pd.read_csv(f'Data/hand_foot/source/case_2_wea.csv', index_col='date')
...
if __name__ == '__main__':
    ...
    graph_data, graph_label = generate_hd_data(args.lb, args.lf, args.adj_mat_method, bool(args.use_tqdm))
